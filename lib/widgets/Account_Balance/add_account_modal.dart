...
Future<void> showAddAccountModal({
  ...
  await showModalBottomSheet(
    ...
    backgroundColor: Colors.white, // makes rounded corners work nicely
    builder: (BuildContext modalContext) {
      return DraggableScrollableSheet(
        expand: false, // allows dragging to full height
        initialChildSize: 0.75, // 85% of screen initially
...
class _AddAccountFormState extends State<AddAccountForm> {
  ...
  Color _selectedColor = availableColors.first;
  ...
  Future<void> _addAccount() async {
    ...
    final hex = Account.colorToHex(_selectedColor);
